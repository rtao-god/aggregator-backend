...
/// <summary>Owns authorization, scope validation, and complete date coverage for listing metrics reads.</summary>
public sealed class ReadListingMetricsRangeService(
    IDailyListingMetricsStore metricsStore,
    IListingMetricsAuthorizer authorizer)
{
    public async Task<IReadOnlyList<DailyListingMetrics>> ReadAsync(
        Guid actorId,
        string catalogKey,
        Guid listingId,
